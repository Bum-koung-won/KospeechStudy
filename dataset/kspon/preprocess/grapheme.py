...
def sentence_to_grapheme(audio_paths, transcripts, vocab_dest: str = './data'):
    ...
    # grpm2id, id2grpm = load_label(os.path.join(vocab_dest, "evalaihub_labels.csv"))
...
def generate_grapheme_labels(grapheme_transcripts, vocab_dest: str = './data'):
    ...
    # label_df.to_csv(os.path.join(vocab_dest, "evalaihub_labels.csv"), encoding="utf-8", index=False)
